...
+ (NSAttributedString *)addAttributesToString:(NSString *)string{
    ...
    CGFloat preferredFontSize = 14;
    
    UIFont *font = [UIFont fontWithName:@"AvenirNext-Regular" size:preferredFontSize];
    ...
    for(NSString *singleString in pTagStrings){
        ...
        UIFont *font = [UIFont fontWithName:@"AvenirNext-Italic" size:preferredFontSize];
    ...
    for(NSString *singleString in preCodeTagStrings){
        ...
        UIFont *font = [UIFont fontWithName:@"Menlo-Regular" size:preferredFontSize];
        NSDictionary *attrsDictionary = [NSDictionary dictionaryWithObject:font forKey:NSFontAttributeName];
